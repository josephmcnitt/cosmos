  ...
  },
  {
    ...
    effects: [
      ...
      { type: 'revealMarker', markerId: 'grove-pythagorean', worldId: 'grove' },
      {
        ...
        body: 'Practice at the Hermetic stone will answer sooner — the microcosm learns to mirror the macrocosm through stance, not argument alone. A Pythagorean stone now answers that ascent through number and harmony.',
      },
      {
        type: 'journalEntry',
        title: 'Next: Hermetic rings',
