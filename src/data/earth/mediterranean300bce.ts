...
export const MEDITERRANEAN_PACK: PolityPack = {
  ...
  sites: [
    ...
    {
      id: 'scetes',
      geo: EARTH_SITE_COORDS.scetes,
      simTimeStart: ceYear(150),
      simTimeEnd: ceYear(600),
      ageId: 'desert',
      linkedEventIds: ['desert-fathers', 'gnostic-gospels'],
    },
    {
      id: 'constantinople',
      geo: EARTH_SITE_COORDS.constantinople,
      simTimeStart: ceYear(400),
      simTimeEnd: ceYear(700),
      ageId: 'byzantium',
      linkedEventIds: ['fall-rome', 'neoplatonism-plotinus'],
    },
    {
      id: 'cordoba',
      geo: EARTH_SITE_COORDS.cordoba,
      simTimeStart: ceYear(750),
      simTimeEnd: ceYear(1100),
      ageId: 'cordoba',
      linkedEventIds: ['islam', 'library-alexandria'],
    },
  ],
};
