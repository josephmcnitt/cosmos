  ...
  },
  {
    ...
    effects: [
      ...
      { type: 'revealMarker', markerId: 'grove-pythagorean', worldId: 'grove' },
      {
        ...
        body: 'Practice at the Hermetic stone will answer sooner — the Pythagorean stone shows how number, breath, and stance can tune the microcosm to the macrocosm.',
      },
      {
        type: 'journalEntry',
        title: 'Next: Hermetic rings',
